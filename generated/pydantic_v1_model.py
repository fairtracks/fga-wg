...
class AnyModel(BaseModel):
    ...
    __root__: bool | dict[str, Any] | float | str | None = Field(
        ...,
...
class Contact(BaseModel):
    ...
    email: constr(regex=r"^\S+@\S+\.\S+$") | None = Field(
        None,
...
class Deposit(BaseModel):
    ...
    deposit_first_created: datetime = Field(
        ...,
    ...
    deposit_last_changed: datetime = Field(
        ...,
...
class Analysis(BaseModel):
    ...
    analysis_label: constr(regex=r"^.{1,60}$") = Field(
        ...,
...
class Document(BaseModel):
    ...
    document_label: constr(regex=r"^.{1,60}$") = Field(
        ...,
...
class Experiment(BaseModel):
    ...
    experiment_label: constr(regex=r"^.{1,60}$") = Field(
        ...,
...
class FileCollection(BaseModel):
    ...
    filecollection_label: constr(regex=r"^.{1,60}$") = Field(
        ...,
...
class Sample(BaseModel):
    ...
    sample_collection_date: datetime | None = Field(
    ...
    sample_label: constr(regex=r"^.{1,60}$") = Field(
        ...,
...
class File(BaseModel):
    ...
    file_label: constr(regex=r"^.{1,60}$") = Field(
        ...,
