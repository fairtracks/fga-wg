...
#   timestamp: 2026-04-10T10:45:19+00:00
...
class InputSource(BaseModel):
    ...
    date_of_retrieval: AwareDatetime | None = Field(
        None,
...
class QualityAssessment(BaseModel):
    ...
    assessment_values: str | list[AssessmentValue] | None = Field(
        ...,
...
class File(BaseModel):
    ...
    checksums: list[Checksum] = Field(
        ...
        examples=[[{"checksum": "535bc9628a1c5e5215226f9996e4eaca", "type": "md5"}]],
    )
    ...
    file_size: int = Field(
        ..., description="For blobs, the blob size in bytes. ", examples=[5359719]
    )
