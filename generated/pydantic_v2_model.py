...
#   timestamp: 2026-04-10T12:00:53+00:00
...
class AssessmentValueIdentifierOptional(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    key: str | None = Field(None, description="Key/name of the assessment value.")
    value: float | bool | int | str | None = Field(
        ..., description="Value corresponding to the assessment key.", title="Any"
    )
...
class QualityAssessment(BaseModel):
    ...
    assessment_values: (
        str
        | dict[str, AssessmentValueIdentifierOptional | float | bool | int | str]
        | None
    ) = Field(
        ...,
