...
| [database_accessions](database_accessions.md) | * <br/> [String](String.md)&nbsp;or&nbsp;<br />[Curie](Curie.md)&nbsp;or&nbsp;<br />[Any](Any.md) | Accession numbers for database records used as input source | direct |
...
| [date_of_retrieval](date_of_retrieval.md) | 0..1 <br/> [Datetime](Datetime.md) | Date of retrieval from the input source, typically used to timestamp download... | direct |
