...
| [Bundle](Bundle.md) | A bundle representing a set of genome annotation files, organised in sub-collections. Metadata has been harmonised in line with the "FAIRification of Genomic Annotations" data model. |
| [BundleMetadata](BundleMetadata.md) | Top-level metadata about a bundle representing a set of genome annotation files, harmonised according to the "FAIRification of Genomic Annotations" data model.  This includes self-referential identifiers and versioning of public deposits of the harmonized metadata. |
...
| [OntologyVersions](OntologyVersions.md) | Information about an ontology used for the bundle. |
...
| [bundle_deposit](bundle_deposit.md) | Information about the public deposit of the bundle. |
| [bundle_description](bundle_description.md) | Human-readable description of the bundle. |
| [bundle_input_sources](bundle_input_sources.md) | References to other input sources from which this entire bundle was derived, or possibly including DOIs of other bundles used as source. |
| [bundle_label](bundle_label.md) | A human-readable description of the bundle, short enough to be used for listings within software user interfaces, tables, illustration legends, etc. |
| [bundle_metadata](bundle_metadata.md) | Top-level metadata about the bundle of genomic annotation files. |
| [bundle_ontology_versions](bundle_ontology_versions.md) | Map from the version-agnostic URL to a versioned URL (e.g. "versionIRI" in owl) of each ontology used in the current metadata deposit (corresponding to deposit_versioned_id"). |
