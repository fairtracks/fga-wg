...
URI: [https://w3id.org/fga-wg/schema/bundle/samples](https://w3id.org/fga-wg/schema/bundle/samples)
...
| ---  | ---  |
| self | https://w3id.org/fga-wg/schema/bundle/samples |
| native | https://w3id.org/fga-wg/schema/bundle/samples |
