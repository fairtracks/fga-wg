...
_Information about particular genome annotation (and other relevant) files._
...
URI: [https://w3id.org/fga-wg/schema/bundle/files](https://w3id.org/fga-wg/schema/bundle/files)
...
| ---  | ---  |
| self | https://w3id.org/fga-wg/schema/bundle/files |
| native | https://w3id.org/fga-wg/schema/bundle/files |
